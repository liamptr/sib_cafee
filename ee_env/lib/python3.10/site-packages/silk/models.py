...
class Response(models.Model):
    request = OneToOneField(
        'Request', related_name='response', on_delete=models.CASCADE)
...
class SQLQuery(models.Model):
    ...
    end_time = DateTimeField(null=True, blank=True)
    time_taken = FloatField(blank=True, null=True)
    request = ForeignKey('Request', related_name='queries',
...
class BaseProfile(models.Model):
    ...
    start_time = DateTimeField(default=timezone.now)
    end_time = DateTimeField(null=True, blank=True)
    request = ForeignKey('Request', null=True, blank=True,on_delete=models.CASCADE)
    time_taken = FloatField(blank=True, null=True)
